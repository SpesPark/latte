...
> **Status**: v1.9 code-side ship-ready. 732/732 tests passing, 23/23 smoke scenarios PASS. First App Store submission was rejected (2026-06-23); the four review issues are fixed in build 1.0.0 (2) and the app is ready to resubmit — see [ROADMAP.md](ROADMAP.md). Pages live at https://spespark.github.io/latte/.
