...
>
> **Current phase**: Coverage gate + Phase 1.5 + UX rewrite (S7 → S7.5 → S7.6 → S7.7 → S7.8); 249/249 tests passing
> **Current session**: 7.8 of ~10 (complete) — App trigger pickable filter + installed-only seed (fix-first after S7.7 smoke)
