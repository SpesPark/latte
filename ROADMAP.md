...
>
> **Current phase**: Coverage gate + Phase 1.5 + UX rewrite (S7 → S7.5 → S7.6 → S7.7 → S7.8 → S7.9); 255/255 tests passing
> **Current session**: 7.9 of ~10 (complete) — Trigger lifecycle: Toggle OFF + watched-list edit now actually deactivate the cup (fix-first after S7.8 smoke)
